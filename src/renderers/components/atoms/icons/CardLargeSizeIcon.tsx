...
export const CardLargeSizeIcon: CardSizeIcon = ({ className, withCheckmark, ...props }) => {
  return (
    <svg className={twMerge(className)} viewBox="0 0 53 22" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <rect x="22" y="0.703125" width="31" height="9.6875" rx="1.9375" className="fill-gray-600" />

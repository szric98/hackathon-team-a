...
export type DropdownIconTriggerProps =
	WithAnalyticsTag<DropdownIconTriggerParams>;

export const DropdownIconTrigger: FC<DropdownIconTriggerProps> = ({
	icon,
	size,
}) => (
	<div className={containerVariants({ size })}>
		<Icon icon={icon} className={iconVariants({ size })} />
	</div>
);

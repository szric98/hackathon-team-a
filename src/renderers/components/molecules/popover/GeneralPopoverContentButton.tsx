...
export const GeneralPopoverContentButton: FC<GeneralPopoverContentButtonProps> = ({
  iconColor,
  onClick,
  prefix,
  suffix,
  ...
  >
    <div className="flex items-center gap-1.5">
      {iconColor && !customIcon && <Icon icon="DotIcon" fill={iconColor} className="size-2" />}
      {customIcon && (
        <span
          style={{
    ...
    <Icon icon="ChevronRightIcon" className="invisible size-3 fill-gray-500 group-hover:visible" />
  </div>
);

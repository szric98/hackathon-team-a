...
import { GeneralPopoverContentLayout, type GeneralPopoverContentLayoutProps } from "./GeneralPopoverContentLayout";
...
export type PopoverPrimitiveProps = PopoverPrimitivePropsWithTrigger | PopoverPrimitivePropsWithAnchor;
...
export const Popover: FC<PopoverPrimitiveProps> = ({
  ...
  return (
    <PopoverPrimitive.Root open={forceOpen !== undefined ? forceOpen : open} onOpenChange={setOpen}>
      {anchor ? (
      ...
      <PopoverPrimitive.Portal>
        ...
        >
          {isValidElement(content) ? (
            ...
            <GeneralPopoverContentLayout heading={content.heading} content={content.content} />
          )}
          {withArrow && <PopoverPrimitive.Arrow className="fill-gray-200 dark:fill-gray-600" />}
        </PopoverPrimitive.Content>
      </PopoverPrimitive.Portal>

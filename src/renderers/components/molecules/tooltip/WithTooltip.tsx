import { Tooltip, type TooltipProps } from "@/renderers/components/molecules/tooltip/Tooltip";
...
const checkTextTruncation = (containerId: string): boolean => {
  ...
  if (textElementTagNames.includes(labelContainer.tagName.toLowerCase() as TextElementTagName)) {

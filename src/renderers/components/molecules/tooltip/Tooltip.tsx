...
export const Tooltip: FC<TooltipProps> = ({ title, trigger, forceOpen, offset, hideArrow, placement }) => {
  return (
    <TooltipPrimitive.Provider>
      <TooltipPrimitive.Root open={forceOpen} delayDuration={0}>
        ...
        >
          {title}
          {!hideArrow && <TooltipPrimitive.Arrow className="fill-gray-900 dark:fill-gray-700" />}
        </TooltipPrimitive.Content>

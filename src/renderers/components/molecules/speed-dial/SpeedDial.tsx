...
export const SpeedDial: FC<SpeedDialProps> = ({ ariaLabel, dataAnalyticsId, items }) => {
  const [open, setOpen] = useState(false);

  return (
    <DropdownMenu.Root open={open} onOpenChange={setOpen}>
      <DropdownMenu.Trigger className="group">
        <Button.Icon icon="PlusIcon" size="lg" dataAnalyticsId={dataAnalyticsId} ariaLabel={ariaLabel} />

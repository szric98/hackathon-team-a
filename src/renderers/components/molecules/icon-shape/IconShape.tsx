...
export type IconShapeProps = WithAriaLabel<WithAnalyticsTagOptional<IconShapeParams>>;
export const IconShape: FC<IconShapeProps> = (props) => {
  const { color, icon, size = "default", shape = "square", className, onClick, dataAnalyticsId, ariaLabel } = props;
...
const containerVariants = /*tw:*/ cva<ContainerVariant>("flex w-min shrink-0 items-center justify-center", {
  variants: {
    size: {
      xxs: "size-4",
      xs: "size-6",

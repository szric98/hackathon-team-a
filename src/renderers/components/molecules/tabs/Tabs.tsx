...
export const Tabs = <T extends object = object>({
	tabs,
	onChange,
	active,
	variant = "underline",
...
const TabTrigger = <T extends object>({
	ref,
	item,
	variant,
	...props
	...
	return (
		...
		>
			<div className="flex items-center">
				{icon && (
					<Icon data-state={dataState} icon={icon} className={iconClassName} />
				)}
			...
			{menuItems && (
				<Dropdown
					...
					Trigger={
						<DropdownIconTrigger
							dataAnalyticsId={`tab-menu__${label}`}
